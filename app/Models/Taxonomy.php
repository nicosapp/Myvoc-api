...
// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'mode', 'actif');
// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'mode', 'passif');
// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'mode', 'gérondif');

// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'tense', 'past');
// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'tense', 'present');
// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'tense', 'future');
// INSERT into taxonomies(user_id, taxonomy, name) values(8, 'tense', 'subjunctiv');
